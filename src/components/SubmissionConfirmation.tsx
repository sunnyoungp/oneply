      ...
      <div className="max-w-2xl w-full mx-auto my-auto py-6">
        <div className="bg-white rounded-2xl p-6 sm:p-8 border border-gray-200 shadow-xs text-center">
          ...
          <div
            ...
            className="bg-[#EFF6FF] border border-[#BFDBFE] rounded-2xl p-4 text-xs text-left mb-6 flex items-start gap-3"
          >
            <TrendingUp className="w-5 h-5 text-[#1D4ED8] shrink-0 mt-0.5" />
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                <span className="font-bold text-[#1D4ED8] text-sm">
                  Match Fit: Strong (94%)
                </span>
                <span className="text-[10px] bg-[#BFDBFE]/70 text-[#1D4ED8] font-bold px-2.5 py-1 rounded-md tracking-wider">
                  ESTIMATE ONLY
                </span>
              </div>
              <p className="text-[#1D4ED8] leading-relaxed text-xs">
                Your income, credit authorization, and cosigner meet the landlord&apos;s published criteria.
              </p>
              <p className="text-[11px] text-[#1D4ED8]/80 italic">
