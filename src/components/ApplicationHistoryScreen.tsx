  ...
  return (
    <div className="min-h-screen bg-white flex flex-col justify-between p-4 sm:p-8 font-sans">
      ...
      <div className="max-w-4xl w-full mx-auto flex items-center justify-between pb-4 border-b border-gray-200">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-1.5 text-xs text-blue-800 bg-blue-50 border border-blue-200 px-3 py-1 rounded-full font-medium">
            <FileText className="w-3.5 h-3.5 text-[#006AFF]" />
      ...
      <div className="max-w-4xl w-full mx-auto py-6">
        ...
        <div className="space-y-3 mb-8">
          {historyList.map((app) => (
            <div
              ...
              className="bg-white rounded-2xl p-4 sm:p-5 border border-gray-200 hover:border-blue-300 hover:shadow-xs transition-all cursor-pointer flex items-center justify-between gap-4 group"
            >
              <div className="flex items-start gap-3.5">
                {app.imageUrl ? (
                  ...
                  <div className="w-14 h-14 rounded-xl bg-blue-50 text-[#006AFF] flex items-center justify-center shrink-0 mt-0.5 group-hover:bg-[#006AFF] group-hover:text-white transition-colors">
        ...
        <div className="bg-blue-50 rounded-2xl p-5 border border-blue-200 flex flex-col sm:flex-row items-center justify-between gap-4">
      ...
      {selectedApp && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4 overflow-y-auto">
          <div className="bg-white rounded-2xl max-w-lg w-full p-6 sm:p-7 shadow-xs border border-gray-200 relative my-8">
            <button
